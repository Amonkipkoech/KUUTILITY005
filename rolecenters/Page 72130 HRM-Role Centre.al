page 86002 "HRM Role C"
{
    ...
    actions
    {
        ...
        area(Reporting)
        {
            ...
            group("CUEAGeneralReports")
            {
                Caption = 'CUEA HRM General Reports';
                ToolTip = 'Get Reports Related to Employee Manager';
                // action(appSumm)
                // {
                //     ApplicationArea = All;
        ...
        area(Embedding)
        {
            ...
            action(departTargets)
            {
                ApplicationArea = all;
                Caption = 'Departmental Targets';
                RunObject = Page "HRM-Departmental Targets";
            }
        ...
        area(sections)
        {
            ...
            group(setus)
            {
                ...
                action("Interview Setup")
                {
                    ...
                    RunObject = Page "HRM-InterviewSetup";
                    ToolTip = 'Executes the Institutions List action.';
                }
            ...
            group(train)
            {
                ...
                action("Training Applications(Individual)")
                {
                    ApplicationArea = all;
                    RunObject = Page "IndividualTrainninglIst.al";
                    ToolTip = 'Executes the Training Applications action.';
                }
