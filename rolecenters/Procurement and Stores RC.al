page 86000 "Procurement & Stores RC"
{
    Caption = 'Procurement and Stores', Comment = '{Dependency=Match,"ProfileDescription_Procurement&Stores"}';
    PageType = RoleCenter;
    ...
    actions
    {
        area(reporting)
        {
            group("Procurement Reports")
            {
                ...
                action("Purchase Requests")
                {
                    ...
                    //Caption = 'Purcha';
                    Image = "Report";
                    RunObject = Report purchaseRequisitions;
                    ToolTip = 'View a list of the vendors from whom you purchase the most or to whom you owe the most.';
                }
                ...
                action(supList)
                {
                    ...
                    Image = "Report";
                    RunObject = Report "Pre-Qualified Suppliers";
                    ToolTip = 'List of Pre-Qualified Suppliers';
                }
            ...
            group(Setups)
            {
                ...
                {
                    ApplicationArea = All;
                    Caption = 'Pre-Qualification Yrs';
                    Image = Receipt;
                    RunObject = Page "Prequalification Periods";
                    ToolTip = 'Preqalification Years';
                }
            }
        ...
        area(sections)
        {
            ...
            //     }
            // }
            //removed stored module from proc according to CUEA scope document
            ...
            group(Contracts)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    RunObject = Page "Proc-Contract List";
                }
                action("Executed Contracts")
                {
                    ApplicationArea = All;
                    RunObject = Page "Proc-Excecuted Contract";
                }

                action("Cancelled Contracts")
                {
                    ApplicationArea = All;
                    RunObject = Page "Proc-Cancelled Contract";
                }
                action("Contracts Report")
                {
                    ApplicationArea = Basic, Suite;
                    RunObject = report "Proc-Contracts Report";
                }
            }
        }
        area(creation)
