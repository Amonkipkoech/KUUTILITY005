page 86004 "PRL-Payroll Role C"
{
    ...
    actions
    {
        ...
        area(Embedding)
        {
            ...
            {
                ApplicationArea = All;
                RunObject = page "updateData";
            }
            action(updatedata2)
            {
                ApplicationArea = All;
                RunObject = page "employerDeduction";
            }
            action(PRLTrans)
            {
        ...
        area(creation)
        {
            ...
            group(PayrollPeoro)
            {
                Caption = 'CUEA Payroll Reports';
                Image = RegisteredDocs;
                action(Action1000000036)

                {
                    ApplicationArea = all;
                    Caption = 'CUEA PAYROLL STAFF';
                    Image = PrintForm;


                    RunObject = Report "PRL-Staff Master Report";
                    ToolTip = 'CUEA Payroll Staff Report';
                }
            ...
            group(prlComparision)
            {
                ...
                action(variance1)
                {
                    ...
                    Image = ItemVariant;
                    RunObject = Report "PRL-Payroll Variance Report3";
                ...
                {
                    ApplicationArea = All;
                    Caption = 'Cummilative Deductions Report';
                    Image = Aging;
